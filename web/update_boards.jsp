...
<html>
    ...
    <body class="create">
        ...
        String boardId2 = request.getParameter("boardId2");
        %>
        <center>
            <div class="jumbotron text-center">
                <form id="form2" action= "UpdateServlet" method="post" enctype="multipart/form-data">
                    <label for="num1">Board title</label>
                    <input type="hidden" name="boardId2" id="boardId2" value="<%=boardId2%>">
                    ...
                    <input style="background: #256F5B; width: 30%;" id="submitB" type="submit" value="Update" class="btn btn-primary" onclick="">
                    </div>
                </form>
            </div>
    </body>
